    ...
    public static class SetupData
    {
        ...
        public static List<PayGrade> _paygrades = new List<PayGrade>()
        {
            ...
            new PayGrade
            {
                ...
                IsActive = true,
                //SupportedOrgRoles = new List<string>() { "Air Wing Senior Enlisted Advisor", "Team Senior Enlisted Advisor", "Command Senior Enlisted Advisor" }
            },
            new PayGrade
            {
                ID = 15,
                ...
                IsActive = true,
                //SupportedOrgRoles = new List<string>() { "Air Wing Senior Enlisted Advisor", "Team Senior Enlisted Advisor", "Squadron Chief", "Platoon Sergeant" }
            },
            //NCOs
            new PayGrade
            {
                ...
                IsActive = true,
                //SupportedOrgRoles = new List<string>() { "Assistant Squadron Leader", "Assistant Platoon Leader", "Flight Leader", "Squad Leader" }
            },
            new PayGrade
            {
                ID = 17,
                ...
                IsActive = true,
                //SupportedOrgRoles = new List<string>() { "Flight Leader", "Squad Leader", "Bomber Pilot", "Combat Search & Rescue Pilot", "Combat Transport Pilot", "Command Pilot", "Corpsman", "Fighter Pilot", "Marksman", "Reconnaissance Operator", "Rifleman", "Strike Pilot", "Combat Engineer" }
            },
            new PayGrade
            {
                ID = 18,
                ...
                IsActive = true,
                //SupportedOrgRoles = new List<string>() { "Bomber Pilot", "Combat Search & Rescue Pilot", "Combat Transport Pilot", "Command Pilot", "Corpsman", "Fighter Pilot", "Marksman", "Reconnaissance Operator", "Rifleman", "Strike Pilot", "Combat Engineer" }
            },
            //Enlisted
            new PayGrade
            {
